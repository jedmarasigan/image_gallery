...
<form method="post" action="${pageContext.request.contextPath}/create">
    <div class = "parentContainer">
        <label class="new_event"><b>Upload Data for New Artist</b></label>
        <div class = "row">
            <div class = "col-sm-12">
        ...
        <div class = "row">
            <div class = "col-sm-12">
                <label class="event-label">Country</label>
        ...
        <div class = "submit">
            <div class = "createbtn">
                <input type = "submit" class = "next_button" value="Next" name="create_artist">
            </div>
        </div>
    </div>
</form>
